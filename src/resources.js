...
export class ResourceMonitor {
  constructor(dataDir=process.cwd()){this.dataDir=dataDir;this.capacity=detectCapacity();this.previous=null;this.at=0;this.current={};this.delay=monitorEventLoopDelay({resolution:20});this.delay.enable();}
  snapshot(){
